...
export default class extends ApplicationController {
  ...
  populateSelect(sourceId, targetId = null) {
    const targetSelectBox = document.getElementById(this.targetElementId)
    ...
    if (sourceId == null || sourceId === "") {
      ...
      fetch(`/${this.sourceRoutePart}/${sourceId}/${this.targetRoutePart}`, {
        ...
        .then(data => {
          ...
          data.forEach(item => {
            ...
            option.innerHTML = item[this.displayAttribute]
